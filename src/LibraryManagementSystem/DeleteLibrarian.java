...
public class DeleteLibrarian extends JFrame{
	...
	public DeleteLibrarian() {
		...
		JLabel lblEnterId = new JLabel("Enter email:");
		...
		btnDelete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String semail=textField.getText();
				if(semail==null||semail.trim().equals("")){
					JOptionPane.showMessageDialog(DeleteLibrarian.this,"email can't be blank");
				}else{
					String email=semail;
					int i=LibrarianDao.delete(email);
					if(i>0){
						JOptionPane.showMessageDialog(DeleteLibrarian.this,"Record deleted successfully!");
					}else{
						JOptionPane.showMessageDialog(DeleteLibrarian.this,"Unable to delete given email!");
					}
				}
			}
		});
